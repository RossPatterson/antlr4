...
#
# self class represents profiling event information for tracking the lookahead
...
class LookaheadEventInfo(DecisionEventInfo):
    ...
    # an SLL prediction
    #
    def __init__(self, decision:int, configs:ATNConfigSet, predictedAlt:int, input:TokenStream, startIndex:int, stopIndex:int, fullCtx:bool):
