...
class AmbiguityInfo(DecisionEventInfo):
    ...
    #
    #def __init__(self, decision:int, configs:ATNConfigSet, ambigAlts:BitSet, input:TokenStream, startIndex:int, stopIndex:int, fullCtx:bool):
    def __init__(self, decision:int, configs:ATNConfigSet, ambigAlts, input:TokenStream, startIndex:int, stopIndex:int, fullCtx:bool):
        super().__init__(decision, configs, input, startIndex, stopIndex, fullCtx)
